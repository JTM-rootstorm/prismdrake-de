...
class ApplicationCatalogOperation final {
  ...
  private:
    ...
    using CatalogResult = foundation::Result<ApplicationCatalogOperation>;
    ...
    friend CatalogResult createApplicationCatalog(DiscoverySnapshot, DesktopExecutableLookupContext,
                                                  std::uint64_t);
};
